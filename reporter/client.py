...
class Reporter:  # pylint: disable = too-many-instance-attributes, too-few-public-methods
    ...
    def __init__(
        ...
        self.custom_fields = objects.CustomFieldManager(self)
        ...
        self.finding_layouts = objects.FindingLayoutManager(self)
        ...
        self.test_cases = objects.TestCaseManager(self)
        self.themes = objects.ThemeManager(self)
        self.tool_findings = objects.ToolFindingManager(self)
        self.tool_targets = objects.ToolTargetManager(self)
